...
window.addEventListener('DOMContentLoaded', () => {
    const loginForm = document.querySelector<HTMLElement>('#loginForm');
...
function loginValidateField(input: HTMLInputElement): boolean {
...
async function checkLoginData(email: string, password: string): Promise<User | undefined> {
    try {
